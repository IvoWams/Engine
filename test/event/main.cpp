...
class TestEventListener1 : public Listener<TestEvent1>
{
    public:
        ...
        ~TestEventListener1() override { printf("%s\n", __func__); }

        void onEvent(TestEvent1* e) override { printf("%s\n", __func__); }
};
...
class TestEventListener23 : public Listener<TestEvent2>, public Listener<TestEvent3>
{
    public:
        ...
        ~TestEventListener23() override { printf("%s\n", __func__); }

        void onEvent(TestEvent2* e) override { printf("%s2\n", __func__); }
        void onEvent(TestEvent3* e) override { printf("%s3\n", __func__); }
};
...
class TestEventDispatcher1 : public Dispatcher<TestEvent1>
{
    public:
        ...
        ~TestEventDispatcher1() override { printf("%s\n", __func__); }
...
class TestEventDispatcher2 : public Dispatcher<TestEvent2>
{
    public:
        ...
        ~TestEventDispatcher2() override { printf("%s\n", __func__); }
};
...
class TestEventDispatcher3 : public Dispatcher<TestEvent3>
{
    public:
        ...
        ~TestEventDispatcher3() override { printf("%s\n", __func__); }
};


int main()
{
    const auto le1 = new TestEventListener1();
    const auto le23 = new TestEventListener23();

    const auto de1 = new TestEventDispatcher1();
    const auto de2 = new TestEventDispatcher2();
    const auto de3 = new TestEventDispatcher3();
